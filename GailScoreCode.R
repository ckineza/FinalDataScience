...
# Add column names
    ...
    hist(view.age$`Absolute risk(5 years)`, ylim = c(0,1.8),freq=FALSE, xlab="5 years projetion", main="Distribution of 5 years absolute risk/age variability", col="lightblue")
    curve(dnorm(x, mean=mean(view.age$`Absolute risk(5 years)`), sd=sd(view.age$`Absolute risk(5 years)`)), add=TRUE, col="red", lwd=2)
    
    hist(view.age$`Lifetime absolute risk`, ylim = c(0,0.6),freq=FALSE, xlab="lifetime projetion", main="Distribution of lifetime/age variability", col="lightblue")
    curve(dnorm(x, mean=mean(view.age$`Lifetime absolute risk`), sd=sd(view.age$`Lifetime absolute risk`)), add=TRUE, col="red", lwd=2)
...
#ggplot(medians.age, aes(medians.age$race)) + geom_bar()
    ...
    hist(medians.age$`Absolute risk(5 years)`, ylim = c(0,2),freq=FALSE, xlab="5 years projetion", main="Distribution of 5 years absolute risk/age median", col="lightblue")
    curve(dnorm(x, mean=mean(medians.age$`Absolute risk(5 years)`), sd=sd(medians.age$`Absolute risk(5 years)`)), add=TRUE, col="red", lwd=2)
    
    hist(medians.age$`Lifetime absolute risk`, ylim = c(0,0.6),freq=FALSE, xlab="lifetime projetion", main="Distribution of lifetime/age median", col="lightblue")
    curve(dnorm(x, mean=mean(medians.age$`Lifetime absolute risk`), sd=sd(medians.age$`Lifetime absolute risk`)), add=TRUE, col="red", lwd=2)
...
# Now see variability in Race
      ...
      races<- (do.call(rbind, race_sequence ))
      colnames(races) <- c("Absolute risk(5 years)","Average absolute risk(5 years)", "Lifetime absolute risk",
                             "Average lifetime risk","race","firstname")
      
      races.age = as.data.frame(unlist(races))
      races.age$`Absolute risk(5 years)` = as.numeric(as.character(races.age$`Absolute risk(5 years)`))
      races.age$`Average absolute risk(5 years)`= as.numeric(as.character(races.age$`Average absolute risk(5 years)`))
      races.age$`Lifetime absolute risk` = as.numeric(as.character(races.age$`Lifetime absolute risk`))
      races.age$`Average lifetime risk` = as.numeric(as.character(races.age$`Average lifetime risk`))
      
      races.age$`Absolute risk(5 years)`= round(races.age$`Absolute risk(5 years)`,2)
      races.age$`Average absolute risk(5 years)`= round(races.age$`Average absolute risk(5 years)`,2)
      races.age$`Lifetime absolute risk` = round(races.age$`Lifetime absolute risk`,2)
      races.age$`Average lifetime risk`= round(races.age$`Average lifetime risk`,2)
      
      hist(races.age$`Absolute risk(5 years)`, ylim = c(0,2),freq=FALSE, xlab="5 years projetion", main="Distribution of 5 years absolute risk/race variability", col="lightblue")
      curve(dnorm(x, mean=mean(races.age$`Absolute risk(5 years)`), sd=sd(races.age$`Absolute risk(5 years)`)), add=TRUE, col="red", lwd=2)
      
      hist(races.age$`Lifetime absolute risk`, ylim = c(0,0.6),freq=FALSE, xlab="lifetime projetion", main="Distribution of lifetime/race variability", col="lightblue")
      curve(dnorm(x, mean=mean(races.age$`Lifetime absolute risk`), sd=sd(races.age$`Lifetime absolute risk`)), add=TRUE, col="red", lwd=2)
